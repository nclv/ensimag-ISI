...
#define KERNEL_CS 0x10 /* Kernel's PL0 (privilege level 0, most privileged) code segment */
#define KERNEL_DS 0x18 /* Kernel's PL0 data segment */
#define USER_CS 0x43   /* User's code descriptor, RPL=3 (Requested Privilege Level) */
